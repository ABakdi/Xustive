...
const ar = {
  ...
  didYouMean: 'هل تقصد',
  showingResultsFor: 'نعرض نتائج',
  searchInsteadFor: 'ابحث بدلًا من ذلك عن',
  filters: 'تصفية',
  language: 'اللغة',
  source: 'المصدر',
  tone: 'الانطباع',
  ...
  calcClear: 'مسح',
  calcBackspace: 'حذف الأخير',
  calcEquals: 'يساوي',
  convAmount: 'الكمية',
  convFrom: 'من',
  convTo: 'إلى',
  convSwap: 'عكس الوحدتين',
  translate: 'ترجمة',
  ...
  reverseTextResults: 'نتائج لهذا النص',
  reverseSearchText: 'ابحث عن هذا النص',
  reverseCopy: 'نسخ',
  reverseCopied: 'تم النسخ',
  reverseNoText: 'لا نص مقروء في الصورة.',
  reverseReadingText: 'جارٍ قراءة النص…',
  reverseClose: 'إغلاق',
  reverseIntro: 'أسقط صورة أو الصقها أو التقطها: نجد أين تظهر على الويب الجزائري، وما يشبهها.',
  reverseDrop: 'أسقط صورة هنا، أو الصقها',
  reverseChoose: 'اختر صورة',
  reverseCamera: 'التقط صورة',
  reverseByPicture: 'ابحث بصورة',
  reverseFindSimilar: 'صور مشابهة',
  reverseUploading: 'جارٍ قراءة الصورة…',
  reverseSearching: 'جارٍ البحث…',
  reverseLooksLike: 'يبدو أنها',
  reverseKind: 'النوع',
  reverseType: 'الصيغة',
  reverseAll: 'الكل',
  reverseSame: 'الصورة نفسها',
  reverseSimilar: 'صور مشابهة',
  reverseWeb: 'من الويب، حسب الوصف',
  reverseNoneSame: 'لم نجد الصورة نفسها.',
  reverseNoneSimilar: 'لا صور مشابهة في الفهرس.',
  reverseNoneWeb: 'لا شيء من الويب لهذا الوصف.',
  reverseUnavailable: 'البحث بالصورة غير متاح حاليا. يمكنك قراءة نص الصورة بدلا من ذلك.',
  reverseFailed: 'تعذّر قراءة هذه الصورة.',
  reversePrivacy: 'تُقرأ الصورة على هذا الخادم ولا تُحفظ ولا تُرسل إلى أي جهة؛ الويب يتلقى الكلمات التي وصفناها بها فقط.',
  reverseReadText: 'اقرأ نص الصورة',
  reverseAnother: 'صورة أخرى',
  style_photo: 'صورة فوتوغرافية',
  style_illustration: 'رسم توضيحي',
  style_digital_art: 'فن رقمي',
  style_render_3d: 'تصيير ثلاثي الأبعاد',
  style_painting: 'لوحة',
  style_drawing: 'رسم بالقلم',
  style_cartoon: 'كرتون',
  style_screenshot: 'لقطة شاشة',
  style_logo: 'شعار',
  style_map: 'خريطة',
  style_diagram: 'مخطط',
  style_meme: 'ميم',
  style_document: 'مستند',
  subject_mosque: 'مسجد',
  subject_casbah: 'القصبة',
  subject_desert: 'صحراء',
  subject_mediterranean_coast: 'ساحل',
  subject_mountains: 'جبال',
  subject_city_street: 'شارع',
  subject_football: 'كرة القدم',
  subject_couscous: 'كسكس',
  subject_traditional_dress: 'لباس تقليدي',
  subject_car: 'سيارة',
  subject_phone: 'هاتف',
  subject_food: 'طعام',
  subject_building: 'مبنى',
  subject_person: 'شخص',
  subject_crowd: 'حشد',
  subject_animal: 'حيوان',
  subject_plant: 'نبات',
  subject_text: 'نص',
  subject_product: 'منتج',
  subject_flag: 'علم',
  subject_sunset: 'غروب',
  subject_night: 'ليل',
...
const fr: Messages = {
  ...
  searchInsteadFor: 'Chercher plutôt',
  filters: 'Filtrer',
  language: 'Langue',
  source: 'Source',
  tone: 'Ton',
  ...
  calcClear: 'Effacer',
  calcBackspace: 'Retour arrière',
  calcEquals: 'Égale',
  convAmount: 'Quantité',
  convFrom: 'De',
  convTo: 'Vers',
  convSwap: 'Inverser les unités',
  ...
  reverseTextResults: 'Résultats pour ce texte',
  reverseSearchText: 'Chercher ce texte',
  reverseCopy: 'Copier',
  reverseCopied: 'Copié',
  reverseNoText: 'Pas de texte lisible dans l’image.',
  reverseReadingText: 'Lecture du texte…',
  reverseClose: 'Fermer',
  reverseIntro: 'Déposez, collez ou photographiez une image : nous trouvons où elle apparaît sur le web algérien, et ce qui lui ressemble.',
  reverseDrop: 'Déposez une image ici, ou collez-la',
  reverseChoose: 'Choisir une image',
  reverseCamera: 'Prendre une photo',
  reverseByPicture: 'Chercher avec une image',
  reverseFindSimilar: 'Images similaires',
  reverseUploading: 'Lecture de l’image…',
  reverseSearching: 'Recherche…',
  reverseLooksLike: 'On dirait',
  reverseKind: 'Genre',
  reverseType: 'Format',
  reverseAll: 'Tout',
  reverseSame: 'La même image',
  reverseSimilar: 'Images similaires',
  reverseWeb: 'Sur le web, par description',
  reverseNoneSame: 'Pas trouvé la même image.',
  reverseNoneSimilar: 'Rien de similaire dans l’index.',
  reverseNoneWeb: 'Rien sur le web pour cette description.',
  reverseUnavailable: 'La recherche par image est indisponible pour le moment. Vous pouvez lire le texte de l’image à la place.',
  reverseFailed: 'Impossible de lire cette image.',
  reversePrivacy: 'L’image est lue sur ce serveur, jamais conservée ni envoyée ailleurs ; le web ne reçoit que les mots qui la décrivent.',
  reverseReadText: 'Lire le texte de l’image',
  reverseAnother: 'Une autre image',
  style_photo: 'photo',
  style_illustration: 'illustration',
  style_digital_art: 'art numérique',
  style_render_3d: 'rendu 3D',
  style_painting: 'peinture',
  style_drawing: 'dessin',
  style_cartoon: 'dessin animé',
  style_screenshot: 'capture d’écran',
  style_logo: 'logo',
  style_map: 'carte',
  style_diagram: 'schéma',
  style_meme: 'mème',
  style_document: 'document',
  subject_mosque: 'mosquée',
  subject_casbah: 'Casbah',
  subject_desert: 'désert',
  subject_mediterranean_coast: 'côte',
  subject_mountains: 'montagnes',
  subject_city_street: 'rue',
  subject_football: 'football',
  subject_couscous: 'couscous',
  subject_traditional_dress: 'tenue traditionnelle',
  subject_car: 'voiture',
  subject_phone: 'téléphone',
  subject_food: 'plat',
  subject_building: 'bâtiment',
  subject_person: 'personne',
  subject_crowd: 'foule',
  subject_animal: 'animal',
  subject_plant: 'plante',
  subject_text: 'texte',
  subject_product: 'produit',
  subject_flag: 'drapeau',
  subject_sunset: 'coucher de soleil',
  subject_night: 'nuit',
...
const en: Messages = {
  ...
  reverseTextResults: 'Results for this text',
  reverseSearchText: 'Search this text',
  reverseCopy: 'Copy',
  reverseCopied: 'Copied',
  reverseNoText: 'No readable text in the picture.',
  reverseReadingText: 'Reading the text…',
  reverseClose: 'Close',
  reverseIntro: 'Drop, paste or photograph a picture: we find where it appears on the Algerian web, and what looks like it.',
  reverseDrop: 'Drop a picture here, or paste one',
  reverseChoose: 'Choose a picture',
  reverseCamera: 'Take a photo',
  reverseByPicture: 'Search by picture',
  reverseFindSimilar: 'Find similar',
  reverseUploading: 'Reading the picture…',
  reverseSearching: 'Searching…',
  reverseLooksLike: 'Looks like',
  reverseKind: 'Kind',
  reverseType: 'Format',
  reverseAll: 'All',
  reverseSame: 'The same picture',
  reverseSimilar: 'Similar pictures',
  reverseWeb: 'From the web, by description',
  reverseNoneSame: 'Nothing that is the same picture.',
  reverseNoneSimilar: 'Nothing similar in the index.',
  reverseNoneWeb: 'Nothing from the web for that description.',
  reverseUnavailable: 'Search by picture is unavailable right now. You can read the picture’s text instead.',
  reverseFailed: 'Could not read that picture.',
  reversePrivacy: 'The picture is read on this server, never stored and never sent anywhere; the web only receives the words we described it with.',
  reverseReadText: 'Read the picture’s text',
  reverseAnother: 'Another picture',
  style_photo: 'photo',
  style_illustration: 'illustration',
  style_digital_art: 'digital art',
  style_render_3d: '3D render',
  style_painting: 'painting',
  style_drawing: 'drawing',
  style_cartoon: 'cartoon',
  style_screenshot: 'screenshot',
  style_logo: 'logo',
  style_map: 'map',
  style_diagram: 'diagram',
  style_meme: 'meme',
  style_document: 'document',
  subject_mosque: 'mosque',
  subject_casbah: 'Casbah',
  subject_desert: 'desert',
  subject_mediterranean_coast: 'coast',
  subject_mountains: 'mountains',
  subject_city_street: 'street',
  subject_football: 'football',
  subject_couscous: 'couscous',
  subject_traditional_dress: 'traditional dress',
  subject_car: 'car',
  subject_phone: 'phone',
  subject_food: 'food',
...
const ary: Messages = {
  ...
  didYouMean: 'تقصد',
  showingResultsFor: 'نوريولك نتائج',
  searchInsteadFor: 'ولا قلّب على',
  filters: 'نقّي',
