...
const ar = {
  ...
  listFilms: "أفلام",
  listAlbums: "ألبومات",
  listRatingNote: "التقييمات من Open Library (بيانات مفتوحة). Goodreads لا يتيح تقييماته للمواقع الأخرى، فالرابط يأخذك إليه مباشرة.",
...
const fr: Messages = {
  ...
  listFilms: "Films",
  listAlbums: "Albums",
  listRatingNote: "Notes d’après Open Library (données ouvertes). Goodreads ne publie pas ses notes pour d’autres sites ; le lien vous y mène directement.",
...
const en: Messages = {
  ...
  listFilms: "Films",
  listAlbums: "Albums",
  listRatingNote: "Ratings from Open Library (open data). Goodreads does not publish its ratings for other sites; the link takes you there directly.",
